...
export const MobileNavigation: React.FC = () => {
  ...
  const navItems: NavItem[] = [
    {
      ...
      href: '/dashboard',
      requiredPermission: 'sections:dashboard',
      icon: (
    ...
    // Scanner tab removed - functionality now in Dashboard
    {
      name: t('nav.myLoans'),
      href: '/my-loans',
      requiredPermission: 'sections:my_loans',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      href: '/consumables',
      requiredPermission: 'sections:consumables',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
   ...
   * Uses dynamic permission checking via useSectionAccess hook
